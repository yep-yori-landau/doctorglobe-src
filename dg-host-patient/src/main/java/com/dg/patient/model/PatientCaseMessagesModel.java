...
public class PatientCaseMessagesModel {
	...
	/**
	 * The id of PatientCaseMessagesModel
	 */
	private BigInteger id;

	/**
	 * The reference of PatientCaseMessagesModel
	 */
	@NotNull
	@Size(min = 1, max = 255)
	...
	/**
	 * The sender_type of PatientCaseMessagesModel
	 */
	@NotNull
	@Size(min = 1, max = 33)
	...
	/**
	 * The sender of PatientCaseMessagesModel
	 */
	@NotNull
	private BigInteger sender;

	/**
	 * The receiver_type of PatientCaseMessagesModel
	 */
	@NotNull
	@Size(min = 1, max = 33)
	...
	/**
	 * The receiver of PatientCaseMessagesModel
	 */
	@NotNull
	private BigInteger receiver;

	/**
	 * The subject of PatientCaseMessagesModel
	 */
	@NotNull
	@Size(min = 1, max = 255)
	...
	/**
	 * The body of PatientCaseMessagesModel
	 */
	@NotNull
	private String body;

	/**
	 * The sent_dt of PatientCaseMessagesModel
	 */
	@NotNull
	private String sent_dt;

	/**
	 * The status of PatientCaseMessagesModel
	 */
	@NotNull
	@Size(min = 1, max = 13)
	...
	/**
	 * The patient_case of PatientCaseMessagesModel
	 */
	@NotNull
