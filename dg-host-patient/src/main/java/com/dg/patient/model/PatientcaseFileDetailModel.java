 ...
 * 
 */
public class PatientcaseFileDetailModel {

	/**
	 * The id of PatientcaseFileDetailModel
	 */
	private BigInteger id;

	/**
	 * The description of PatientcaseFileDetailModel
	 */
	private String description;

	/**
	 * The file_type of PatientcaseFileDetailModel
	 */
	@NotNull
	@Size(min = 1, max = 255)
	...
	/**
	 * The file_dt of PatientcaseFileDetailModel
	 */
	private Timestamp file_dt;

	/**
	 * The patient_case of PatientcaseFileDetailModel
	 */
	@NotNull
	private BigInteger patient_case;

	/**
	 * The name of PatientcaseFileDetailModel
	 */
	private String name;

	/**
	 * The document of PatientcaseFileDetailModel
	 */
	@NotNull
