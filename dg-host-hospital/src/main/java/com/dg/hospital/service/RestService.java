...
import com.dg.hospital.model.CorporatecompanyInsuranceModel;
...
public class RestService {
	...
	public HospitalModel getHospital(BigInteger id) {
		String url = this.getRestUrlService().getHealthcareproviderUrl()
				+ "/get/id/" + id;
		logger.info("Hospital url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalModel> responseEntity = restTemplate
					.getForEntity(url, HospitalModel.class);
	...
	public Integer setHospital(HospitalForm model) {		
		String url = this.getRestUrlService().getHealthcareproviderUrl()
				+ "/create/user/"+this.getUserId()+"/type/hospital-user/";
	 ...
	 * @return hospital
	 */
	public Integer setHospital(HospitalModel model) {
	...
	public List<EquipmentModel> getAllEquipments() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<EquipmentModel[]> responseEntity = restTemplate
					.getForEntity(url, EquipmentModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalEquipmentModel> getHospitalEquipments(
		...
		String url = this.getRestUrlService()
				.getHealthcareproviderEquipmentUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("hospital equipments url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalEquipmentModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalEquipmentModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public Integer setHospitalEquipment(HospitalEquipmentModel model) {
		UserService userService = new UserService();
		String url = this.getRestUrlService()
				.getHealthcareproviderEquipmentUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
	 ...
	 * @return Integer
	 */
	public Integer deleteHospitalEquipment(BigInteger id) {
		String url = this.getRestUrlService()
				.getHealthcareproviderEquipmentUrl() + "/delete/id/" + id+"/user/"+this.getUserId()+"/type/hospital-user";
		logger.info("Hospital Equipment Delete url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
	...
	public List<AccreditationModel> getAllAccreditation() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<AccreditationModel[]> responseEntity = restTemplate
					.getForEntity(url, AccreditationModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 */
	public List<HospitalAccreditationModel> getHospitalAccreditation(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService()
				.getHealthcareproviderAccreditationUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("hospital equipments url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalAccreditationModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalAccreditationModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public Integer setHospitalAccreditation(HospitalAccreditationModel model) {
		UserService userService = new UserService();
		String url = this.getRestUrlService()
				.getHealthcareproviderAccreditationUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public Integer deleteHospitalAccreditation(BigInteger id) {
		UserService userService = new UserService();
		String url = this.getRestUrlService()
				.getHealthcareproviderAccreditationUrl() + "/delete/id/" + id+"/user/"+this.getUserId()+"/type/hospital-user/";;
	...
	public List<HospitaltypeModel> getAllHospitaltype() {
		String url = this.getRestUrlService().getHealthcareprovidertypeUrl()
				+ "/getAll";
		logger.info("healthcareprovidertype url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitaltypeModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitaltypeModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 */
	public List<HospitalHospitaltypeModel> getHospitalHospitaltype(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService()
				.getHealthcareproviderHealthcareprovidertypeUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Hospitaltype url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalHospitaltypeModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalHospitaltypeModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public Integer setHospitalHospitaltype(HospitalHospitaltypeModel model) {		
		String url = this.getRestUrlService()
				.getHealthcareproviderHealthcareprovidertypeUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
		logger.info("Hospital Hospitaltype url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<Integer> responseEntity = restTemplate
	...
	public Integer deleteHospitalHospitaltype(BigInteger id) {		
		String url = this.getRestUrlService()
				.getHealthcareproviderHealthcareprovidertypeUrl()
				+ "/delete/id/" + id+"/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public List<FeatureModel> getAllFeature() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<FeatureModel[]> responseEntity = restTemplate
					.getForEntity(url, FeatureModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalunitModel> getAllHospitalunit() {
		String url = this.getRestUrlService().getHealthcareproviderunitUrl()
				+ "/getAll";
		logger.info("Hospital unit url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalunitModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalunitModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 */
	public List<HospitalUnitFeatureModel> getHospitalUnitFeature(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService()
				.getHealthcareproviderUnitFeatureUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Unit Feature url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalUnitFeatureModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalUnitFeatureModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public Integer setHospitalUnitFeature(HospitalUnitFeatureModel model) {		
		String url = this.getRestUrlService()
				.getHealthcareproviderUnitFeatureUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public Integer deleteHospitalUnitFeature(BigInteger id) {		
		String url = this.getRestUrlService()
				.getHealthcareproviderUnitFeatureUrl() + "/delete/id/" + id+"/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public List<AmenityModel> getAllAmenity() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<AmenityModel[]> responseEntity = restTemplate
					.getForEntity(url, AmenityModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalAmenityModel> getHospitalAmenity(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService().getHealthcareproviderAmenityUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Amenity url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalAmenityModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalAmenityModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<CuisineModel> getAllCuisine() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<CuisineModel[]> responseEntity = restTemplate
					.getForEntity(url, CuisineModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalCuisineModel> getHospitalCuisine(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService().getHealthcareproviderCuisineUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Cuisine url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalCuisineModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalCuisineModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalLanguageModel> getHospitalLanguage(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService()
				.getHealthcareproviderLanguageUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Cuisine url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalLanguageModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalLanguageModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public Integer setHospitalLanguage(HospitalLanguageModel model) {
		UserService userService = new UserService();
		String url = this.getRestUrlService()
				.getHealthcareproviderLanguageUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public Integer deleteHospitalLanguage(Integer id) {
		UserService userService = new UserService();
		String url = this.getRestUrlService()
				.getHealthcareproviderLanguageUrl() + "/delete/id/" + id+"/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public List<InsuranceModel> getAllInsurance() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<InsuranceModel[]> responseEntity = restTemplate
					.getForEntity(url, InsuranceModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 */
	public List<HospitalInsuranceModel> getHospitalInsurance(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService()
				.getHealthcareproviderInsuranceUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Insurance url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalInsuranceModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalInsuranceModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public Integer setHospitalInsurance(HospitalInsuranceModel model) {
		UserService userService =new UserService();
		String url = this.getRestUrlService()
				.getHealthcareproviderInsuranceUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
		logger.info("Hospital Insurance url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<Integer> responseEntity = restTemplate
	 ...
	 * @return boolean
	 */
	public Boolean deleteHospitalInsuranceByHealthcareprovider(
			BigInteger healthcareprovider) {
		UserService userService = new UserService();
		String url = this.getRestUrlService()
				.getHealthcareproviderInsuranceUrl()
				+ "/delete/healthcareprovider/" + healthcareprovider+"/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public Integer deleteHospitalInsurance(BigInteger id) {
		UserService userService = new UserService();
		String url = this.getRestUrlService()
				.getHealthcareproviderInsuranceUrl() + "/delete/id/" + id+"/user/"+this.getUserId()+"/type/hospital-user/";
		logger.info("Hospital Insurance Delete url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<Integer> responseEntity = restTemplate.getForEntity(
	...
	public List<HospitalPhotoModel> getHospitalImages(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService().getHealthcareproviderPhotoUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Photo url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalPhotoModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalPhotoModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 */
	public HospitalPhotoModel getHospitalPhotoById(BigInteger id) {
		String url = this.getRestUrlService().getHealthcareproviderPhotoUrl()
				+ "/get/id/" + id;
		logger.info("Hospital Photo url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
	...
	public List<StateModel> getStateByCountry(Integer country) {
		String url = this.getRestUrlService().getStateUrl() + "/get/country/"
				+ country;
	...
	public List<CityModel> getCityByCountry(Integer country) {
		String url = this.getRestUrlService().getCityUrl() + "/get/country/"
				+ country;
		logger.info("url found {}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
	...
	public List<CityModel> getCityByState(Integer state) {
		String url = this.getRestUrlService().getCityUrl() + "/get/state/"
				+ state;
		logger.info("url found {}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
	...
	public List<ChainModel> getAllChain() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<ChainModel[]> responseEntity = restTemplate
					.getForEntity(url, ChainModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<RatingcompaniesModel> getAllRatingcompanies() {
		String url = this.getRestUrlService().getRatingcompaniesUrl()
				+ "/getAll";
		logger.info("Chain url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<RatingcompaniesModel[]> responseEntity = restTemplate
					.getForEntity(url, RatingcompaniesModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalRatingsModel> getHospitalRatings(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService().getHealthcareproviderRatingsUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Ratings url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalRatingsModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalRatingsModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<SpecialtyModel> getAllSpecialty() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<SpecialtyModel[]> responseEntity = restTemplate
					.getForEntity(url, SpecialtyModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<SpecialtyTreatmentModel> getAllSpecialtyTreatment() {
		String url = this.getRestUrlService().getSpecialtyTreatmentUrl()
				+ "/getAll";
		logger.info("Speciality Treatment url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<SpecialtyTreatmentModel[]> responseEntity = restTemplate
					.getForEntity(url, SpecialtyTreatmentModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 * @return all specialty treatment
	 */
	public List<SpecialtyTreatmentModel> getSpecialtyTreatmentBySpeciality(
			BigInteger specialty) {
		String url = this.getRestUrlService().getSpecialtyTreatmentUrl()
				+ "/get/specialty/" + specialty;
		logger.info("Find Speciality Treatment by speciality url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<SpecialtyTreatmentModel[]> responseEntity = restTemplate
	 ...
	 */
	public HospitalSpecialtyModel getHospitalSpecialtyById(BigInteger id) {
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyUrl() + "/get/id/" + id;
		logger.info("Get Hospital Specialty By id url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalSpecialtyModel> responseEntity = restTemplate
					.getForEntity(url, HospitalSpecialtyModel.class);
			return responseEntity.getBody();
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalSpecialtyModel> getHospitalSpecialty(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info(
				"Get Hospital Specialty By Healthcareprovider url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalSpecialtyModel[]> responseEntity = restTemplate
	...
	public Integer deleteHospitalSpecialty(BigInteger id) {
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyUrl() + "/delete/id/" + id;
	...
	public Integer setHospitalSpecialty(HospitalSpecialtyModel model) {
		...
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public HospitalSpecialtyTreatmentMethodModel getHospitalSpecialtyTreatmentMethodById(
			BigInteger id) {
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodUrl()
				+ "/get/id/" + id;
		logger.info(
				"Get Hospital Specialty Treatment Method By Id url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalSpecialtyTreatmentMethodModel> responseEntity = restTemplate
					.getForEntity(url,
							HospitalSpecialtyTreatmentMethodModel.class);
			return responseEntity.getBody();
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalSpecialtyTreatmentMethodModel> getHospitalSpecialtyTreatmentMethodByHealthcareproviderSpecialty(
		...
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodUrl()
				+ "/get/healthcareprovider_specialty/"
				+ healthcareproviderSpecialty;
		logger.info(
				"Get Hospital Specialty Treatment Method By Healthcareprovider Speciality url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalSpecialtyTreatmentMethodModel[]> responseEntity = restTemplate
	 ...
	 * @return hospital specialty treatment method
	 */
	public List<HospitalSpecialtyTreatmentMethodModel> getHospitalSpecialtyTreatmentMethodBySpecialty(
			BigInteger specialty) {
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodUrl()
				+ "/get/specialty/"
	...
	public List<HospitalSpecialtyTreatmentMethodModel> getHospitalSpecialtyTreatmentMethodByHealthcareproviderSpecialtyTreatment(
		...
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodUrl()
				+ "/get/healthcareprovider_specialty/"
				+ healthcareproviderSpecialty + "/treatment/" + treatment;
		logger.info(
				"Get Hospital Specialty Treatment Method By Healthcareprovider Speciality url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
	...
	public List<HospitalSpecialtyTreatmentMethodModel> getHospitalSpecialtyTreatmentMethodByHealthcareprovider(
		...
		String url = this.getRestUrlService()
				...
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info(
				"Get Hospital Specialty Treatment Method By Healthcareprovider url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalSpecialtyTreatmentMethodModel[]> responseEntity = restTemplate
	 ...
	 * @return integer
	 */
	public Integer setHospitalSpecialtyTreatmentMethod(
			HospitalSpecialtyTreatmentMethodModel model) {
	
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
		logger.info("Hospital Specialty Treatment Method create url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<Integer> responseEntity = restTemplate
	...
	public Integer deleteHospitalSpecialtyTreatmentMethod(BigInteger id) {
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodUrl()
				+ "/delete/id/" + id;
		logger.info("Hospital Specialty Treatment Method Delete url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<Integer> responseEntity = restTemplate.getForEntity(
	...
	public List<MethodModel> getAllMethod() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<MethodModel[]> responseEntity = restTemplate
					.getForEntity(url, MethodModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalSpecialtyTreatmentMethodPractitionerModel> getHospitalSpecialtyTreatmentMethodPractitionerByHstm(
		...
		String url = this.getRestUrlService()
				...
				+ "/get/hstm/" + hstm;
		logger.info(
				"Get Hospital Speciality Treatment Method Practitioner By Healthcareprovider specialty treatment method url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
	 ...
	 * @return hospital specialty treatment method practitioner
	 */
	public List<HospitalSpecialtyTreatmentMethodPractitionerModel> getHospitalSpecialtyTreatmentMethodPractitionerBySpecialty(
			BigInteger specialty) {
		String url = this.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodPractitionerUrl()
				+ "/get/specialty/" + specialty;
	...
	public List<HospitalSpecialtyTreatmentMethodPractitionerModel> getHospitalSpecialtyTreatmentMethodPractitionerByHealthcareprovider(
		...
		String url = this.getRestUrlService()
				...
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info(
				"Get Hospital Specialty Treatment Method Practitioner By Healthcareprovider url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalSpecialtyTreatmentMethodPractitionerModel[]> responseEntity = restTemplate
	...
	public PractitionerModel getPractitionerById(BigInteger id) {
		String url = this.getRestUrlService().getPractitionerUrl() + "/get/id/"
				+ id;
	 ...
	 */
	public List<HospitalPractitionerModel> getHospitalPractitioner(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService().getPractitionerUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
	 ...
	 */
	public List<PractitionerLanguageModel> getPractitionerLanguage(
			BigInteger practitioner) {
		String url = this.getRestUrlService().getPractitionerLanguageUrl()
				+ "/get/practitioner/" + practitioner;
		logger.info("Practitioner Language url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<PractitionerLanguageModel[]> responseEntity = restTemplate
					.getForEntity(url, PractitionerLanguageModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<AttestationsModel> getAllAttestations() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<AttestationsModel[]> responseEntity = restTemplate
					.getForEntity(url, AttestationsModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 */
	public List<PractitionerAttestationsModel> getPractitionerAttestations(
			BigInteger practitioner) {
		String url = this.getRestUrlService().getAttestationsPractitionerUrl()
				+ "/get/practitioner/" + practitioner;
		logger.info("Practitioner Language url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<PractitionerAttestationsModel[]> responseEntity = restTemplate
					.getForEntity(url, PractitionerAttestationsModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 * @return integer
	 */
	public Integer setPractitionerAttestations(
			PractitionerAttestationsModel model) {		
		String url = this.getRestUrlService().getAttestationsPractitionerUrl()
				+ "/create/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public List<SpecialtyModel> getHospitalSpecialtyFormList(
			BigInteger healthcareprovider) {
		...
		List<HospitalSpecialtyModel> hospitalSpecialtyModelList = this
				.getHospitalSpecialty(healthcareprovider);
	...
	public List<SpecialtyModel> getSpecialtyFormList(
			BigInteger healthcareprovider) {
		Boolean found = false;
	...
	public Integer setPractitioner(PractitionerModel model) {		
		String url = this.getRestUrlService().getPractitionerUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
	...
	public List<PractitionertypeModel> getAllPractitionertype() {
		String url = this.getRestUrlService().getPractitionertypeUrl()
				+ "/getAll";
		logger.info("Practitioner type url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<PractitionertypeModel[]> responseEntity = restTemplate
					.getForEntity(url, PractitionertypeModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<AclRolesModel> getAllAclRoles() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<AclRolesModel[]> responseEntity = restTemplate
					.getForEntity(url, AclRolesModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<StatsModel> getStats() {
		...
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<StatsModel[]> responseEntity = restTemplate
					.getForEntity(url, StatsModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<HospitalSpecialtyTreatmentMethodPractitionerStatModel> getHospitalSpecialtyTreatmentMethodPractitionerStatByHstmp(
		...
		String url = this
				.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodPractitionerStatUrl()
				+ "/get/hstmp/" + hstmp;
		logger.info(
				"Get Hospital Speciality Treatment Method Practitioner Stat By hstmp url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalSpecialtyTreatmentMethodPractitionerStatModel[]> responseEntity = restTemplate
					.getForEntity(
							url,
							HospitalSpecialtyTreatmentMethodPractitionerStatModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 * @return integer
	 */
	public Integer setHospitalSpecialtyTreatmentMethodPractitionerStat(
			HospitalSpecialtyTreatmentMethodPractitionerStatModel model) {	
		String url = this
				.getRestUrlService()
				.getHealthcareproviderSpecialtyTreatmentMethodPractitionerStatUrl()
				+ "/create/user/"+this.getUserId()+"/type/hospital-user/";
		logger.info(
				"Hospital Speciality Treatment Method Practitioner Stat create url found ={}",
				url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<Integer> responseEntity = restTemplate
	 ...
	 * @return
	 */
	public String getHospitalCurrency(BigInteger healthcareprovider) {
		HospitalModel model = this.getHospital(healthcareprovider);
		if (!model.getId().equals(null) && !model.getCurrency().equals(null)) {
			logger.info("hospital currency found ={}",model.getCurrency());
	...
	public User getUserById(BigInteger id) {
		String url = this.getRestUrlService().getUserUrl() + "/get/id/" + id;
		logger.info("url found {}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
	...
	public Integer setUser(User model) {		
		String url = this.getRestUrlService().getUserUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
	 ...
	 * @return integer
	 */
	public Integer setHospitalPractitioner(HospitalPractitionerDetailModel model) {
		String url = this.getRestUrlService().getHealthcareproviderPractitionerUrl() + "/create/user/"+this.getUserId()+"/type/hospital-user/";
		logger.info("Hospital Practitioner create url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<Integer> responseEntity = restTemplate
					.postForEntity(url, model, Integer.class);
	 ...
	 * @return all hospital practitioner
	 */
	public List<HospitalPractitionerDetailModel> getHospitalPractitionerDetail(
			BigInteger healthcareprovider) {
		String url = this.getRestUrlService().getHealthcareproviderPractitionerUrl()
				+ "/get/healthcareprovider/" + healthcareprovider;
		logger.info("Hospital Practitioner url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<HospitalPractitionerDetailModel[]> responseEntity = restTemplate
					.getForEntity(url, HospitalPractitionerDetailModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	 ...
	 * @return hospital
	 */
	public List<HospitalPractitionerDetailModel> getAllHospitalPractitioner() {
		String url = this.getRestUrlService().getHealthcareproviderPractitionerUrl()
				+ "/getAll";
		logger.info("Hospital Practitioner url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
	...
	public Boolean policyFileTypeValidate(String filetype){
	...
	public Double getHospitalPrice(BigInteger healthcareproviderSpecialty,BigInteger treatment){		
		List<HospitalSpecialtyTreatmentMethodModel> hospitalSpecialityTreatmentMethodModelList = this.getHospitalSpecialtyTreatmentMethodByHealthcareproviderSpecialty(healthcareproviderSpecialty);
		Double hospitalPrice = 0.0;
		if(hospitalSpecialityTreatmentMethodModelList != null){			
				for(HospitalSpecialtyTreatmentMethodModel hstm: hospitalSpecialityTreatmentMethodModelList){
					if(hstm.getTreatment().equals(treatment) && hstm.getActive()){					
						hospitalPrice = hstm.getHealthcareproviderPrice();
						break;
					}
				}			
		}
	...
	public Double getHospitalPriceByHstm(BigInteger hstm){		
		HospitalSpecialtyTreatmentMethodModel hospitalSpecialityTreatmentMethodModel = this.getHospitalSpecialtyTreatmentMethodById(hstm);
		Double hospitalPrice = 0.0;
		if(hospitalSpecialityTreatmentMethodModel.getId() != null && hospitalSpecialityTreatmentMethodModel.getHealthcareproviderPrice() != null){			
			hospitalPrice = hospitalSpecialityTreatmentMethodModel.getHealthcareproviderPrice();
	...
	/**
	 * 
	 * @return Corporatecompany Insurance Lis
	 */
	public List<CorporatecompanyInsuranceModel> getAllCorporatecompanyInsurance() {
		String url = this.getRestUrlService().getCorporatecompanyInsuranceUrl() + "/getAll";
		logger.info("Stats url found ={}", url);
		RestTemplate restTemplate = new RestTemplate();
		try {
			ResponseEntity<CorporatecompanyInsuranceModel[]> responseEntity = restTemplate
					.getForEntity(url, CorporatecompanyInsuranceModel[].class);
			return Arrays.asList(responseEntity.getBody());
		} catch (Exception ex) {
			logger.error(ex.getMessage());
		}
	...
	public List<Integer> getYearsPracticedList(){
		List<Integer> yearsPracticedList = new ArrayList<Integer>();
		int year = Calendar.getInstance().get(Calendar.YEAR);
		int toyear = year-100;
		for(int x=year;x >= toyear; x--){
			yearsPracticedList.add(x);
		}
		return yearsPracticedList;
	}
	...
	public List<CountryModel> getCountryByAsc(){
		List<CountryModel> countryList = this.getCountry();
		Collections.sort(countryList, this.countryName);
		return countryList;
	}
	
	/*Comparator for sorting the list by asc*/
	public static Comparator<CountryModel> countryName = new Comparator<CountryModel>(){
